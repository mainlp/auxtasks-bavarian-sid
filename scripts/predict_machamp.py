...
from machamp.predictor.predict import predict_with_paths  # Adjust as per your directory structure
...
parser.add_argument("model_dir", type=str, help="The path to the directory containing the model files.")
...
if len(args.file_paths) % 2 == 1:
    logger.error('Error: the number of files passed is not even. You need to pass an output file for each input file: ' + str(args.file_paths))
    exit(1)
